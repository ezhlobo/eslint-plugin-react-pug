...
module.exports = {
  ...
  create: detectComponents((context, components) => {
    ...
    function reportUndefinedPropType(component, props = {}) {
      (component.usedPropTypes || []).forEach((usedProp) => {
        if (usedProp && !props[usedProp.name]) {
          context.report({
            node: component.node,
            message: MISSING_MESSAGE,
            loc: usedProp.node.loc,
            data: {
              name: usedProp.name,
            },
          })
    ...
    function reportUndefinedPropTypes(component) {
      reportUndefinedPropType(component, component.declaredPropTypes)
    }
      ...
      'Program:exit': function () {
        ...
        Object.keys(list)
          ...
          .forEach((id) => {
            ...
            reportUndefinedPropTypes(component)
          })
      },
    }
  }),
